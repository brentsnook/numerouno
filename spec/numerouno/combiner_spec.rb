...
describe Numerouno::Combiner do
  ...
  it 'will only combine numbers of the correct power' do
  ...
  describe 'multiplication' do
    ...
    it 'will be applied to the number on the left' do
      combined([2, 1000]).should eql([2000])
    end
    
    it 'will not happen when the current number is the first' do
    ...
    it 'will happen when the current power is greater than ten' do
      @power = 10
  ...
  describe 'addition' do
    ...
    it 'will add the number on the right' do
      combined([1000, 5]).should eql([1005])
    end
    
    it 'will not happen when the current number is the last' do
    ...
    it 'will not happen when the number is less than number to the right' do
